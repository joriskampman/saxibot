...
def generate_launch_description():
  ...
  # ---------- THE ROBOT AND ALL COMPONENTS (lidar/camera....) ---------------------------
  ...
  # ---------------   websocket launcher   -------------------------------------------------------
  websocket_file = os.path.join(get_package_share_directory("rosbridge_server"),
                                'launch',
                                'rosbridge_websocket_launch.xml')
  websocket = IncludeLaunchDescription(XMLLaunchDescriptionSource([websocket_file]))
